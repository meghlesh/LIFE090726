...
function initContactForm() {
  ...
  async function handleSubmit(e) {
    ...
    if (isFirstNameValid && isLastNameValid && isEmailValid && isPhoneValid && isMessageValid) {
      ...
      fetch('https://https://api-lifeqa-be.azurewebsites.net/api/contact/submit', {
        method: 'POST',
...
function initNewsletter() {
  ...
  finalForm.addEventListener('submit', async function(e) {
    ...
    try {
      const response = await fetch('https://https://api-lifeqa-be.azurewebsites.net/api/email/subscribe', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
